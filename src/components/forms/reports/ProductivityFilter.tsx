...
interface FilterOptions {
    ...
    dap_begin: string
    dap_end: string
    min_production: string
    max_production: string
}

const ProductivityFilter: FC<FilterProps> = ({ currentQuery, setCurrentQuery }) => {
    ...
    return (
        <>
            ...
            <GeralInput
                ...
                name='min_production'
                maskVariant='price'
                defaultValue={filterOptions.min_production}
                onChange={handleInputChange}
                placeholder='Digite aqui'
            />
            <GeralInput
                label='Produtividade (max) '
                name='max_production'
                maskVariant='price'
                defaultValue={filterOptions.max_production}
                max={getActualDate()}
                onChange={handleInputChange}
                placeholder='Digite aqui'
            />
