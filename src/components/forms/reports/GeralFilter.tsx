...
const GeralFilter: FC<FilterProps> = ({ currentQuery, setCurrentQuery }) => {
    ...
    return (
        <>
            ...
            <GeralInput
                label='Data inicial (DAE)'
                name='dae_begin'
                type='date'
                defaultValue={filterOptions.dae_begin}
                max={filterOptions.dae_end}
                onChange={handleInputChange}
            />
            <GeralInput
                label='Data final (DAE)'
                name='dae_end'
                type='date'
                defaultValue={filterOptions.dae_end}
                max={getActualDate()}
                onChange={handleInputChange}
            />

            <GeralInput
                label='Data inicial (DAA)'
                name='daa_begin'
                type='date'
                defaultValue={filterOptions.daa_begin}
                max={filterOptions.daa_end}
                onChange={handleInputChange}
            />
            <GeralInput
                label='Data final (DAA)'
                name='daa_end'
                type='date'
                defaultValue={filterOptions.daa_end}
                max={getActualDate()}
                onChange={handleInputChange}
            />
            <GeralInput
