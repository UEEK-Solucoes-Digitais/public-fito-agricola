...
const ApplicationFilter: FC<FilterProps> = ({ currentQuery, setCurrentQuery }) => {
    ...
    return (
        <>
            ...
            <GeralInput
                label='DEPUA Fungicida (início)'
                name='depua_begin'
                maskVariant='integer'
                placeholder='00'
                defaultValue={filterOptions.depua_begin}
                onChange={handleInputChange}
            />
            <GeralInput
                label='DEPUA Fungicida (final)'
                name='depua_end'
                maskVariant='integer'
                placeholder='00'
                defaultValue={filterOptions.depua_end}
                onChange={handleInputChange}
            />

            <GeralInput
                label='DAA - Fungicida (início)'
                name='daa_begin'
                maskVariant='integer'
                placeholder='00'
